...
function addPagination($array, $recordPerPage, $page)
{
    ...
    <nav>
        <ul class="pagination">
            <li class="page-item ' . $GLOBALS['hideStart'] . '">
                <a class="page-link" href="' . $page . '&page=' . intval($_GET['page'] - 1)  . '" aria-label="Previous">
    ...
    for ($i = 1; $i <= $numOfPage; $i++) {
        ...
        echo '
        <li class="page-item">
            <a class="page-link ' . $txt . '" href="' . $page . '&page=' . $i . '">' . $i . '</a>
        </li>
        ';
    }
    echo '
            <li class="page-item ' . $GLOBALS['hideEnd'] . '">
                <a class="page-link" href="' . $page . '&page=' . intval($_GET['page'] + 1) . '" aria-label="Next">
                    <span aria-hidden="true">»</span>
                </a>
            </li>
        </ul>
